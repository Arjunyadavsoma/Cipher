...
import 'package:mimir_ai/core/services/firebase_background_handler.dart';
...
Future<void> main() async {
  ...
  print(
    "Firebase apps before: ${Firebase.apps.length}",
  );
  ...
  print(
    "Firebase apps after: ${Firebase.apps.length}",
  );
