...
class GfgFetchService {
  ...
  Future<DsaQuestion> fetchProblemOfTheDay() async {
    try {
      final rawHtml =
          await _toolManager.executeTool('http', {
      ...
      final extractionPrompt =
          "Extract the Problem of the Day from this GeeksforGeeks HTML. "
      ...
      final llmResponse = await _toolManager.executeTool('groq', {
        'systemPrompt':
            'You are an HTML parser. You only output valid JSON. No markdown, no explanation.',
